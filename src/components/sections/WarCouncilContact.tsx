...
const FormInput = ({ id, placeholder, type = "text", value, onChange, activeField, setActiveField }: FormInputProps) => {
  ...
  return (
    <span className="relative inline-block mx-2 group">
      <input 
        ...
        className="bg-transparent border-b border-metallic-brass/10 text-metallic-brass focus:border-metallic-brass focus:outline-none px-2 py-1 transition-all duration-700 min-w-[200px] md:min-w-[280px] w-full md:w-auto relative z-10"
      />
...
export default function WarCouncilContact() {
  ...
  return (
    <section id="contact" className="py-fb9 relative overflow-hidden border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-10 gap-fb7 items-start">
          ...
          <div className="md:col-span-12 lg:col-span-3 space-y-12 h-full lg:border-l lg:border-white/5 lg:pl-12 pt-12 lg:pt-0">
             ...
             <div className="p-fb4 border border-white/5 bg-royal-obsidian/40 blade-motif">
                <p className="text-metallic-brass font-ui text-[10px] tracking-[0.5em] mb-fb3 uppercase">Private Connection</p>
