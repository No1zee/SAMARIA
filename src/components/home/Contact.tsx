      ...
      <div className="container max-w-[1200px] mx-auto px-6 grid md:grid-cols-2 gap-16">
        ...
        >
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4 group">
                    ...
                    <span className="font-ui text-sm text-off-white">mission@samaria.tech</span>
                </div>
                ...
                <div className="flex items-center gap-4 group">
                    ...
                    <span className="font-ui text-sm text-off-white">+254 700 000 000</span>
                </div>
                ...
                <div className="flex items-center gap-4 group">
                    ...
                    <span className="font-ui text-sm text-off-white">Nairobi, Kenya // Global Grid</span>
                </div>
            </div>
        </motion.div>
        ...
        >
            <div className="space-y-6">
                ...
                <button 
                    type="button"
                    className="w-full bg-gold-metallic font-ui font-bold uppercase tracking-widest py-4 hover:brightness-110 transition-all clip-path-slant flex items-center justify-center gap-2"
                >
                    <Send className="w-4 h-4 text-royal-obsidian" />
                    <span className="text-royal-obsidian">Transmit Data</span>
                </button>
            </div>
        </motion.form>
