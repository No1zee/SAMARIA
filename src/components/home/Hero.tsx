...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex flex-col overflow-hidden py-24 md:py-0">
      ...
      <div className="container max-w-[1500px] mx-auto px-fb3 md:px-fb4 flex-1 relative z-10 grid grid-cols-1 md:grid-cols-10 items-center">
        ...
        <div className="md:col-span-8 flex flex-col justify-center text-left py-fb7 pt-[15vh]">
          ...
          <h1 className="mb-fb5 font-heading w-full uppercase">
              ...
              <div className="overflow-hidden mb-2">
                <div className="hero-title-line ml-4 md:ml-[8vw]">
                  <EclipseText 
                    className="text-[12vw] sm:text-[14vw] md:text-[8rem] tracking-tight font-black leading-none block"
              ...
              <div className="mb-4">
                <div className="hero-title-line">
                  <EclipseText 
                    className="text-[10vw] md:text-[8rem] lg:text-[10rem] tracking-tighter font-black leading-none block"
              ...
              <div className="overflow-hidden mb-2">
                <div className="hero-title-line ml-4 md:ml-[13vw]">
                  <EclipseText 
              ...
              <div className="overflow-hidden">
                <div className="hero-title-line ml-4 md:ml-[5vw]">
                  <EclipseText 
                    className="text-[12vw] md:text-[6rem] tracking-widest font-black block"
          ...
          <div className="hero-content text-off-white/40 max-w-sm ml-4 md:ml-[13vw] mt-fb2 md:mt-0 mb-fb6 text-base md:text-xl font-body leading-relaxed opacity-0">
              <CelestialText intensity={0.5}>
                <p>
          ...
          <div className="hero-content opacity-0 flex flex-col md:flex-row items-start gap-fb4 ml-4 md:ml-[13vw]">
