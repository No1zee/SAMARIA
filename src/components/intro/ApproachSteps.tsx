      ...
      <div className="container max-w-[1500px] mx-auto px-fb3 md:px-fb4 relative z-10">
        ...
        >
          ...
          <h2 className="font-heading text-4xl md:text-8xl font-bold text-off-white mb-6 uppercase leading-[0.9]">
            <CelestialText intensity={1.2}>FIVE STEPS. NO SHORTCUTS.</CelestialText>
          </h2>
          <div className="text-off-white/80 text-lg md:text-2xl font-body leading-relaxed max-w-2xl italic no-prose">
            <CelestialText intensity={0.6}>
              Every project follows a clear sequence from discovery to handover. The goal is not just launch, but a system that remains stable, understandable, and easy to build on.
            </CelestialText> 
          </div>
          <motion.p 
            initial={{ opacity: 0 }}
          ...
          >
            Built carefully. Handed over properly.
          </motion.p>
        </motion.div>
